!function(t, i, s) {
    function e(t, s) {
        if (this.wrapper = "string" == typeof t ? i.querySelector(t) : t,
        ...
        _move: function(t) {
            if (this.enabled && h.eventType[t.type] === this.initiated) {
                ...
                !(c - this.endTime > 300 && 10 > o && 10 > n)) {
                    if (this.directionLocked || this.options.freeScroll || (this.directionLocked = o > n + this.options.directionLockThreshold ? "h" : n >= o + this.options.directionLockThreshold ? "v" : "n"),
